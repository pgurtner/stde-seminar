...
def extract_and_plot(benchmack_case_suffix):
    LOG_DIR = "benchmarks/logs" + benchmack_case_suffix
    PLOT_DIR = "benchmarks/plots" + benchmack_case_suffix
...
extract_and_plot("-normal")
extract_and_plot("-uss-mem")
extract_and_plot("-rss-mem")
